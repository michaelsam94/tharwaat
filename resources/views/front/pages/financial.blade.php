            ...
            <div class="row">
                <div class="col-auto">
                    <div class="align-container" style="height:170px">
                        <h2 class="heading__title"><span>{{ __('groups.finHeader') }}</h2>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                                        <div class="heading heading--primary"><span
                                            ...
                                            <h2 class="heading__title color--white">
                                                <span>{{ __('groups.finTitle') }}
                                                </span>
                                            </h2>
                                        </div>
                                        <p class="color--white">{{ __('groups.finP1') }} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center flex-column-reverse flex-lg-row">
                            <div class="col-lg-6 col-xl-6">
                                <div class="heading heading--primary"><span class="heading__pre-title"></span>
                                    <h2 class="heading__title"><span>{{ __('groups.finTitle2') }}
                                        </span> </h2>
                                </div>
                                <p><strong>{{ __('groups.finP2') }}
                                    </strong></p>
