            ...
            <div class="row">
                <div class="col-auto">
                    <div class="align-container" style="height:170px">
                        <h2 class="heading__title"><span>{{ __('groups.energyHeader') }}
                        </h2>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-xl-6 offset-xl-1">
                                        ...
                                        <a target="_blank" class="button stories-item__button button--blue"
                                            href="https://univergysolar.com/">{{ __('groups.energyCTA') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center flex-column-reverse flex-lg-row">
                            <div class="col-lg-6 col-xl-6">
                                <div class="heading heading--primary"><span class="heading__pre-title"></span>
                                    <h2 class="heading__title"><span>{{ __('groups.energyTitle2') }}
                                        </span> </h2>
                                </div>
                                <p><strong>
                                        {{ __('groups.energyP2') }} </strong></p>
