<section class="section">
    ...
    <div class="projects-slider">
        <div class="projects-slider__item">
            <div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
                <div class="projects-masonry__img">
                    @php
                        $projectImage1 = \App\Models\WebsiteContent::active()->where('key', 'projects.image1')->first();
                    @endphp
                    @if($projectImage1)
                        <img class="img--bg" src="{{ $projectImage1->image_url }}" alt="{{ $projectImage1->content }}"/>
                    @endif
        ...
        <div class="projects-slider__item">
            <div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
                <div class="projects-masonry__img">
                    @php
                        $projectImage2 = \App\Models\WebsiteContent::active()->where('key', 'projects.image2')->first();
                    @endphp
                    @if($projectImage2)
                        <img class="img--bg" src="{{ $projectImage2->image_url }}" alt="{{ $projectImage2->content }}"/>
                    @endif
        ...
        <div class="projects-slider__item">
            <div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
                <div class="projects-masonry__img">
                    @php
                        $projectImage3 = \App\Models\WebsiteContent::active()->where('key', 'projects.image3')->first();
                    @endphp
                    @if($projectImage3)
                        <img class="img--bg" src="{{ $projectImage3->image_url }}" alt="{{ $projectImage3->content }}"/>
                    @endif
                    <div class="projects-masonry__inner"><span class="projects-masonry__badge">Medicine</span>
    ...
    <div class="container">
        <div class="row margin-top">
            ...
            <div class="col-lg-4 text-center text-lg-right"><a class="button button--blue" href="#">All works</a></div>
        </div>
    </div>
</section>
