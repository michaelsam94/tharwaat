...
@section('content')
    <section class="promo-primary">
        <picture>
            <source srcset="{{ asset('design/front/img/images/slider2.jpg')}}" media="(min-width: 992px)"/>
            <img class="img--bg" src="{{ asset('design/front/img/images/slider2.jpg')}}" alt="img"/>
        </picture>
        <div class="container">
            <div class="row">
                <div class="col-auto">
                    <div class="align-container">
                        <div class="align-container__item">
                            <h1 class="promo-primary__title color--white"><span>Join Us</span></h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contacts-wrapper">
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-xl-12">
                        <form class="form message-form" action="{{ route('uploadResume') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <h6 class="form__title">Upload your Resume</h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form__field" type="text" name="job_title" placeholder="Job Title"/>
                                </div>
                                <div class="col-lg-6">
