                                            ...
                                            <div class="col-lg-6 col-xl-5">
                                                <div class="img-box">
                                                    <div class="img-box__img">
                                                        <img class="img--bg" src="{{ asset('/manage/img/groups_content/'.$content->image) }}" alt="img"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xl-6 offset-xl-1">
                                                <div class="heading heading--primary"><span class="heading__pre-title color--mono"></span>
                                                    <h2 class="heading__title color--white"><span>{{ $content->title }}</span> </h2>
                                                </div>
                                                <p class="color--white">{{ $content->description }}</p>
                                                @if(!is_null($content->website))
                                                    <a target="_blank" class="button stories-item__button button--blue" href="{{ $content->website }}">Webiste</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
